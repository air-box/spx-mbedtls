...
/**
 * \def MBEDTLS_SSL_REMOTE_ATTESTATION
 *
 * Enable support for remote attestation.
 *
 * Comment this macro to disable support for Remote Attestation.
 */
#define MBEDTLS_SSL_REMOTE_ATTESTATION
