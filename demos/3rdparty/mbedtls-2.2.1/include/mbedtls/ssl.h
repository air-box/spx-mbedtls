...
#define MBEDTLS_SSL_REMOTE_ATTESTATION_DISABLED      0
#define MBEDTLS_SSL_REMOTE_ATTESTATION_ENABLED       1
...
#define MBEDTLS_TLS_EXT_REMOTE_ATTESTATION          56
...
#define MBEDTLS_SUPPORTED_ATTESTATION_NUM   4
#define MBEDTLS_ATTESTATION_TYPE_NONE       0
#define MBEDTLS_ATTESTATION_TYPE_INTEL_SGX  1
#define MBEDTLS_ATTESTATION_TYPE_TPM        2
#define MBEDTLS_ATTESTATION_TYPE_UNKNOWN    3
#endif
...
#endif
#if defined(MBEDTLS_SSL_REMOTE_ATTESTATION)
    unsigned int remote_attestation : 1;    /*!< server remote attestation? */
    unsigned int remote_attestation_req : 1; /*< client remote attestation? */
    unsigned char *target_attestation_list;
    size_t target_attestation_list_len;
    unsigned char *supported_attestation_list;
    size_t supported_attestation_list_len;
    unsigned char *quote;
    size_t quote_size;
#endif
};
...
#if defined (MBEDTLS_SSL_REMOTE_ATTESTATION)
    unsigned char supported_attestation_type;
    unsigned char target_attestation_type;
#endif
...
#if defined(MBEDTLS_SSL_REMOTE_ATTESTATION)
/**
 * \brief          Set the supported Remote Attestation Type.
 *
 * \param conf     SSL configuration
 * \param protos   NULL-terminated list of supported protocols,
 *                 in decreasing preference order.
 ...
 * \return         Protcol name, or NULL if no protocol was negotiated.
 */
//const int mbedtls_ssl_get_retmoe_attestation( const mbedtls_ssl_context *ssl );
